...
@section('contenido')
	<form action="{{ route('ind') }}" method="get">
		...
		<label for="Clave" class="p_bottom">Confirmar contraseña:</label>
		<input type="password" name="Clavec" id="Clave" required="true" class="p_bottom"><br>
